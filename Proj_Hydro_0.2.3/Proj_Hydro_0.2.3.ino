...
// Ver 0.2.3
// Modified by: Mike Schwindt on 11/5/18
// Needed to set up warning system for humidity and tempature after almost losing a plant
// This modification will be implimented to the enclosure today.
/*
  Blink
...
void setup() 
{
  ...
  pinMode(7, OUTPUT); // Tetsing pin with (white) led
